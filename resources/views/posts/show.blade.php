                ...
                <section class="col-span-8 col-start-5 mt-10 space-y-6">
                            ...
                            <form action="/posts/{{ $post->slug }}/comments" method="POST">
                                ...
                                <div class="mt-8">
                                    <textarea name="body" class="w-full text-sm focus:outline-none focus:ring" rows="5"
                                        placeholder="Quick, write something to comment...">
                                </textarea>
                                </div>
                    ...
                    @else
                        <p class="font-semibold">
                            <a href="/register" class="hover:underline">Register</a> or <a href="/login" class="hover:underline">Log in to comment!</a>
                        </p>
                    @endauth
